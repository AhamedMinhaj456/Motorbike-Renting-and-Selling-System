...
function Navigation() {
    ...
    return (
        <Navbar bg="light" expand="lg">
            <Container>
                <LinkContainer style={{ fontSize: '36px', color: 'red', fontWeight: 'bold'}} to="/">
                
                <Navbar.Brand >Shaa </Navbar.Brand>
                </LinkContainer>
                <LinkContainer style={{ fontSize: '18px',marginRight:'-40', marginTop: '48px', fontWeight: 'bold'}} to="/">
                <Navbar.Brand >We are Leaders in Renting and Selling </Navbar.Brand>
                </LinkContainer>
