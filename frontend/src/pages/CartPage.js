...
const stripePromise = loadStripe("pk_test_51O2CGJSFyCK83PL894VE7aSXiq01AxQHS4an2PVyoE9YRSMJPew2cPL9UzGfQfxWqw0jHGO2xya4QVVFOBTbGQiJ00b9EAFXEx");
...
function CartPage() {
    ...
    return (
        <Container style={{ minHeight: "95vh" }} className="cart-container">
            <Row>
                <Col>
                    <h1 className="pt-2 h3">cart</h1>
                    {cart.length == 0 ? (
                        <Alert variant="info">cart is empty. Add Motorbikes to your cart</Alert>
                    ) : (
